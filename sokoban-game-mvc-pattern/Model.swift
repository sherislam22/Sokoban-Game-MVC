...
public class Model {
    ...
    private var playerFaceDirection: String
    ...
    public func ifNotConnection() {
        viewer.notConnectionAlert()
    }
    public func returnFirstLevel() {
        level = 1
        initialization()
        viewer.update()
    }
    ...
    func getplayerfacedirection() -> String {
